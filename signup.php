...
<div class="red header" id="header_signup">
<div class="home">
...
<div class="red">
	<form>
		<p class="input_text">Korisničko ime</p>
  		<input class="unos" id="signupUser"  type="text" name="username"><br><br>
  		<p class="input_text">E-mail</p>
  		<input class="unos" id="signupEmail" type="text" name="email"><br><br>
  		<p class="input_text">Lozinka</p>
  		<input class="unos" id="signupPass1" type="password" name="password"><br><br>
  		<p  class="input_text">Potvrdi lozinku</p>
  		<input  class="unos" id="signupPass2" type="password" name="confirm_password"><br><br>
  		<input class="btn" id="registracijaBtn" onclick="validirajRegistraciju()" type="button" name="login" value="Registracija">
	</form>
	<p id="greskaSignup" class="greska"></p>
</div>
